...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  const searchItems = useMemo(
    () => [
      ...
      { label: "Bilty", href: "/bilty", keywords: "bilty list table overview" },
      { label: "Create Bilty", href: "/bilty/add", keywords: "new add bilty" },
      { label: "Bilty Parties", href: "/bilty/parties", keywords: "party master bilty parties" },
      { label: "Sales", href: "/sales", keywords: "sales bill list table" },
      { label: "Create Sale", href: "/sales/new", keywords: "new add sale" },
      { label: "Gunny Bags", href: "/gunny", keywords: "gunny bags overview records" },
      { label: "Add Gunny Record", href: "/gunny/add", keywords: "new add gunny record" },
      { label: "Gunny Sellers", href: "/gunny/sellers", keywords: "gunny sellers payment ledger purchase details" },
