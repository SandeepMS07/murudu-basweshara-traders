  ...
  return (
    <div className="h-screen overflow-hidden bg-[#0b0b0d] text-zinc-100 selection:bg-zinc-700/50">
      <div className="flex h-full min-h-0 flex-col px-2 py-2 lg:px-6 lg:py-6">
        <div className="flex items-center justify-between rounded-xl border border-[#1d1f24] bg-[#111214] px-4 py-3 lg:hidden">
          <button
            type="button"
            aria-label={menuOpen ? "Close menu" : "Open menu"}
            onClick={() => setMenuOpen((value) => !value)}
            className="flex h-10 w-10 cursor-pointer items-center justify-center rounded-lg border border-[#282b31] bg-[#16181d] text-zinc-200"
          >
            {menuOpen ? <X className="h-5 w-5" /> : <Menu className="h-5 w-5" />}
          </button>
          <span className="text-lg font-semibold tracking-tight text-zinc-100">PB Manager</span>
          <div className="h-10 w-10" />
        </div>

        <div className="mt-2 flex min-h-0 flex-1 overflow-hidden rounded-3xl border border-[#1d1f24] bg-[#0f1013] shadow-[0_24px_70px_rgba(0,0,0,0.55)] lg:mt-0">
          ...
          <main className="min-h-0 min-w-0 w-full flex-1 overflow-auto bg-[#0f1013]">
            <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 p-4 lg:p-8">
              <header className="sticky top-0 z-20 rounded-2xl border border-[#1d1f24] bg-[#111214]/95 px-4 py-3 backdrop-blur-md">
                <div className="flex flex-wrap items-center justify-between gap-4">
                  ...
                  <div className="flex w-full flex-wrap items-center justify-end gap-2 lg:w-auto">
                    <div className="relative min-w-[220px] flex-1 lg:w-72 lg:flex-none" ref={searchRef}>
